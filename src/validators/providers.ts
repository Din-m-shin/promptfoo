...
export const ProviderEnvOverridesSchema = z.object({
  ...
  A6000_API_KEY: z.string().optional(),
  ...
  A770_API_KEY: z.string().optional(),
  KONAN_API_HOST: z.string().optional(),
  KONAN_API_BASE_URL: z.string().optional(),
  KONAN_BASE_URL: z.string().optional(),
  KONAN_MODEL_NAME: z.string().optional(),
  KONAN_API_KEY: z.string().optional(),
